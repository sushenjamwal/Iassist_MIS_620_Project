<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cur.aspx.cs" Inherits="cur" %>
                ...
                <div class="about">
                    <div class="about-top">
                        ...
                        <p class="MsoNormal">
                                        <o:p></o:p></p>
                                    <p class="style5">
                                        MSIS Concentrations<o:p></o:p></p>
                                    <p class="MsoNormal">
                                        <![if !supportLists]><span>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><![endif]></p>
                        <p class="MsoNormal">
                                        <span class="style6">Business Intelligence &amp; Analytics</span><span><br />
                        ...
                        <p class="MsoNormal">
                                    ...
                                    <p class="MsoNormal">
                                        <o:p></o:p></p>
                                    <p class="MsoNormal">
                                        <span class="style6">Business Process Management</span><span><br />
                        ...
                        <p class="MsoNormal">
                                    ...
                                    <p class="MsoNormal">
                                        <o:p></o:p></p>
                                    <p class="MsoNormal">
                                        <span class="style6">Social Media</span><span><br />
                        ...
                        <p class="MsoNormal">
                                        <o:p></o:p></p>
                                    <p class="MsoNormal">
                                        <span class="style6">Project Management</span><span><br />
                                        his concentration provides project and program management concepts, with an 
