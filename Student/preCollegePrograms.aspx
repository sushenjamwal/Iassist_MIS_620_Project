<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="preCollegePrograms.aspx.cs" Inherits="preCollegePrograms" %>
                ...
                <div class="about">
                    <div class="about-top">
                        <table class="style1">
                            <tr>
                                <td class="style3">
                                    <h2 style="margin-top: 0px; color: rgb(163, 38, 56); font-family: TradeGothicLTStdBoldExtended; font-weight: normal; font-size: 18px; font-style: normal; font-variant: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
                                        EXPAND YOUR WORLD AND YOUR THINKING</h2>
                                    <p style="margin-top: 0px; color: rgb(163, 38, 56); font-family: TradeGothicLTStdBoldExtended; font-weight: normal; font-size: 18px; font-style: normal; font-variant: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
                                        &nbsp;</p>
                                    <p style="line-height: 1.4; font-size: 18px; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); width: 776px;">
                                        <table class="style1">
                                            <tr>
                                                <td class="style1" colspan="2">
                                                    The Stevens Summer is a pre-college experience that challenges, and promotes 
                                                    discovery and exploration. Each summer, talented high school students from the 
                                                    United States and all over the world come to Stevens for a true residential 
                                                    college experience. Get a taste of campus life, experience hands-on projects, 
                                                    visit successful companies, take a bite out of the Big Apple, and make your 
                                                    college application stand out!<br />
                                                    <br />
                                                    <br />
                                                </td>
                                                <td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Image ID="Image2" runat="server" Height="272px" 
                                                        ImageUrl="~/Student/images/preCollage.png" Width="469px" />
                                                </td>
                                                <td>
                                                    &nbsp;</td>
                                            </tr>
                                    ...
                                    <p style="line-height: 1.4; font-size: 18px; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); width: 439px;">
                                        &nbsp;</p>
                                    <p style="line-height: 1.4; font-size: 18px; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); width: 439px;">
                                        &nbsp;</p>
                                </td>
