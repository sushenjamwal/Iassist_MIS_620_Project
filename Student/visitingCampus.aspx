<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="visitingCampus.aspx.cs" Inherits="visitingCampus" %>
                        ...
                        <table class="style1">
                            <tr>
                                <td>
                                    <h2 class="style2" 
                                        ...
                                        <strong class="style3">Why Stevens?</strong></h2>
                                    ...
                                    <p style="line-height: 1.4; font-size: 18px; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
                                        Green lawns, distinctive buildings, and helpful people greet Stevens visitors. 
                                        You will most certainly take notice of the spectacular view from our campus, 
                                        situated high on a bluff overlooking the Hudson River and the Manhattan skyline. 
                                        Our hometown of Hoboken, New Jersey – ranked one of the top college towns in the 
                                        nation by The Princeton Review – offers a variety of boutiques, restaurants, 
                                        parks, and nightlife, as well as beautiful Victorian brownstones and marvelous 
                                        architecture. New York City is so close by – just 10 minutes from Hoboken’s 
                                        historic train station to lower Manhattan – that opportunities for exposure to 
                                        the culture, business, and entertainment of that tremendous city abound.</p>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                <td>
                                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/stevensImage.jpg" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
